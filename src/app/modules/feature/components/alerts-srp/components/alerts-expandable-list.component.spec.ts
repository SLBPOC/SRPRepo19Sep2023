...
import { AlertsExpandableListComponent } from './alerts-expandable-list.component';
...
describe('AlertsExpandableListComponent', () => {
  let component: AlertsExpandableListComponent;
  let fixture: ComponentFixture<AlertsExpandableListComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ AlertsExpandableListComponent ,WellFilterAndSortComponent],
    ...
    fixture = TestBed.createComponent(AlertsExpandableListComponent);
